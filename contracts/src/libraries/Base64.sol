...
/**
 * @title Base64
 * @dev Base64 encoding/decoding library for on-chain metadata generation
...
library Base64 {
    ...
    /**
     * @dev Encode bytes data to base64 string
    ...
    /**
     * @dev Encode a string to base64 (convenience function)
